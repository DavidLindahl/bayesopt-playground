...
class CNN(nn.Module):
    def __init__(self, conv_nodes_1, conv_nodes_2, kernel_size_1, kernel_size_2, maxpool_size, dropout_rate, fc_nodes):
        ...
        self.conv2 = nn.Conv2d(in_channels=conv_nodes_1, out_channels=conv_nodes_2, kernel_size=kernel_size_2, padding=1)
